...
function Header() {
    ...
    // States - input query for search function
    ...
    const searchMovies = async (e) => {
        ...
        data.results.forEach(movie => console.log(movie.original_title, movie.release_date )); 
    ...
    return (
        <header className={dropDown ? "show" : "hide"}>
            ...
            <form onSubmit={searchMovies}>
                ...
                <input type="search" id="search-bar" placeholder="i.e. Jurassic Park" value={query} onChange={(e) => setQuery(e.target.value)}/>
